  ...
  return (
    <div className='flex items-center justify-between gap-x-5'>
        <div className='flex flex-col items-center justify-center'>
            <NavLink activeclassname="active" to="/user/dashboard" className="text-xs mb-1 p-2 rounded-lg bg-opacity-10 w-inherit flex-row gap-x-4 items-center text-opacity-70 nav-button" data-tip data-for="dashboard">
        ...
        {hasPermissions(['*', 'business.*', 'items.*', 'items.read']) && 
            <div className='flex flex-col items-center justify-center'>
                <NavLink activeclassname="active" to="/user/items" className="text-xs mb-1 p-2 rounded-lg bg-opacity-10 w-inherit flex-row gap-x-4 items-center text-opacity-70 nav-button" data-tip data-for="tickets">
                    <div className='relative w-full'>
        ...
        {hasPermissions(['*', 'business.*', 'items.*', 'items.read']) && 
            <div className='flex flex-col items-center justify-center'>
                <NavLink activeclassname="active" to="/user/orders/new-order" className="bg-ss-dark-blue text-xs mb-3 w-16.25 h-16.25 flex items-center justify-center rounded-full -mt-7.5 w-inherit shadow-lg shadow-ss-dark-blue/10 border-2 border-white">
        ...
        {hasPermissions(['*', 'business.*', 'inventory.*', 'inventory.read']) && 
            <div className='flex flex-col items-center justify-center'>
                <NavLink activeclassname="active" to="/user/inventory" className="text-xs mb-1 p-2 rounded-lg bg-opacity-10 w-inherit flex-row gap-x-4 items-center text-opacity-70 nav-button" data-tip data-for="events">
                    <div className='relative w-full'>
        ...
        {hasPermissions(['*', 'business.*', 'stores.*', 'stores.read']) && 
            <div className='flex flex-col items-center justify-center'>
                <NavLink activeclassname="active" to="/user/settings" className="text-xs mb-1 p-2 rounded-lg bg-opacity-10 w-inherit flex-row gap-x-4 items-center text-opacity-70 nav-button" data-tip data-for="settings">
                    <div className='relative w-full'>
