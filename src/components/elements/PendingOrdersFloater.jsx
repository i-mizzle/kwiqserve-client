  ...
  return (
    <>
        {pendingOrdersCount > 0 && <Link
            to={`/business/orders`} 
            ref={componentRef} 
            className={`pending-orders-floater fixed h-max bottom-25 lg:top-10 xl:top-20 z-90 rounded-full py-3 px-6 right-4 bg-green-500 border border-white shadow-xl shadow-green-500/20 ${isHighlighted ? 'highlight-pulse' : ''}`}
        >
