...
const OrderStatus = ({status}) => {
  return (
    <>
        {status === "PENDING" &&
            <span className="px-2 py-1 rounded text-gray-600 font-medium bg-gray-400 bg-opacity-10 text-xs">
                {/* <Circle width={15} /> */}
                Pending
            </span>
        }
        ...
        {status === "PREPARING_ORDER" &&
            <span className="px-2 py-1 rounded text-yellow-800 font-medium bg-yellow-400 bg-opacity-10 text-xs">
                {/* <Circle width={15} /> */}
                Preparing order
            </span>
        }
        ...
        {status === "OUT_FOR_DELIVERY" &&
            <span className="px-2 py-1 rounded text-green-800 font-medium bg-green-200 bg-opacity-40 block text-xs">
                {/* <CheckIcon /> */}
                Out for delivery
            </span>
        }
