...
const AppLayout = ({children, pageTitle}) => {
    ...
    const { enablePushNotifications, isLoading, isCheckingStatus, isSubscribed, isBlocked, error } = usePushNotifications();
        ...
        <Fragment>
            <div className="flex flex-row bg-white">
                <div className={`flex flex-col clear-left min-h-screen z-10 w-full`}>
                    ...
                    {!isCheckingStatus && !isSubscribed && !isBlocked && <div className='mt-20 rounded-lg -mb-15 p-3 bg-yellow-50 border border-yellow-800/20 mx-auto w-11/12 lg:w-9/12 shadow-xl shadow-yellow-800/5 lg:flex items-start'>
